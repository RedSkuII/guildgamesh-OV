...
export default function UserContributionsPage() {
  ...
  const fetchContributions = async () => {
    try {
      ...
      const response = await fetch(`/api/leaderboard/${userId}?timeFilter=${timeFilter}&page=${currentPage}&pageSize=${pageSize}`)
        ...
        <div className="bg-guildgamesh-100 dark:bg-stone-800 rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
              ...
              <div className="text-sm text-purple-700 dark:text-purple-300">Current Rank</div>
            </div>
          </div>
        </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs ${getStatusColor(contribution.resourceStatus)}`}>
                              {contribution.resourceStatus.replace('_', ' ')}
                            </span>
                          </div>
                          <div className="flex items-center gap-4 mt-1 text-sm text-gray-500 dark:text-gray-400">
                            <span>{contribution.actionType.toLowerCase()} {contribution.quantityChanged.toLocaleString()}</span>
                            <span>•</span>
